...
public class FormPretragaKupca extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtPretraga.setForeground(new java.awt.Color(0, 0, 255));
        txtPretraga.setSelectedTextColor(new java.awt.Color(0, 0, 204));
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (row >= 0) {
            JOptionPane.showMessageDialog(rootPane, "Sistem je ucitao kupca.");
