...
import FormPredmet.FormNoviPredmet;
...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        miNoviPredmet = new javax.swing.JMenuItem();
        ...
        txtDatumIsporuke.setText("18.08.2023");
        ...
        miNoviPredmet.setText("noviPredmet");
        miNoviPredmet.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                miNoviPredmetActionPerformed(evt);
            }
        });
        jMenu10.add(miNoviPredmet);
    ...
    private void miNoviPredmetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miNoviPredmetActionPerformed
        new FormNoviPredmet(this, true).setVisible(true);
    }//GEN-LAST:event_miNoviPredmetActionPerformed
    ...
    private javax.swing.JMenuItem miNoviPredmet;
    ...
    private void popuniKnjige() {
        try {
            ArrayList<Knjiga> knjige = ClientController.getInstance().getAllKnjiga();
    ...
    private void izracunajKonacnuCenu() {
        ...
        if (kupac.getTipKupca().equals("PREMIUM PLUS")) {
    ...
    private void podesiBoju() {
        ...
        btnDodajStavku.setForeground(Color.black);
        btnDodajStavku.setBackground(Color.green);

        btnObrisiStavku.setForeground(Color.black);
        btnObrisiStavku.setBackground(Color.green);

        jMenu6.setForeground(Color.red);
        jMenu7.setForeground(Color.red);
